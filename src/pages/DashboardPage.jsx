...
const dashboardTrends = {
  ...
  chartSummary:
    "A steady climb in collected waste across the last month, with a mid-cycle recovery in the core districts.",
  chartData: [
    18, 22, 16, 14, 19, 31, 44, 52, 58, 51, 44, 40, 42, 47, 59, 66, 61, 54, 49,
    45, 47, 52, 58, 63, 70, 77,
  ],
...
function DashboardPage() {
  return (
    <section className="dashboard-page">
      <Header
        title={dashboardTrends.title}
        subtitle={dashboardTrends.subtitle}
      />
          ...
          <div className="submission-list">
            {dashboardTrends.recentItems.map((item) => (
              ...
              >
                ...
                <span
                  className={`status-pill${item.approved ? " approved" : ""}`}
                >
                  {item.status}
                </span>
              </div>
