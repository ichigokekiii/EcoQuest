  ...
  return (
    <article className="mission-card">
      <div className="mission-card-header">
        ...
        <span className={`mission-card-badge mission-card-badge-${mission.status.toLowerCase()}`}>
          {mission.status}
        </span>
      </div>
      ...
      <div className="mission-card-actions">
        <button type="button" className="mission-button secondary">Edit</button>
        <button type="button" className="mission-button primary">View Details</button>
      </div>
    </article>
  )
}
