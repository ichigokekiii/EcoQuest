...
const verificationItems = [
  {
    ...
    type: 'PET Bottles',
    timeAgo: '2 hrs ago',
    image: 'https://images.unsplash.com/photo-1540518614846-fb2d6c4fdadf?auto=format&fit=crop&w=900&q=80',
  },
  {
    name: 'Juan Dela Cruz',
    ...
    type: 'Cans',
    timeAgo: '3 hrs ago',
    image: 'https://images.unsplash.com/photo-1524594154909-9f7e5c684d2c?auto=format&fit=crop&w=900&q=80',
  },
  {
    name: 'Ana Reyes',
    ...
    type: 'Cardboard',
    timeAgo: '5 hrs ago',
    image: 'https://images.unsplash.com/photo-1544505407-9d5bdfd4dcc7?auto=format&fit=crop&w=900&q=80',
  },
]
...
function VerificationCard({ item }) {
  return (
    <article className="verification-card">
      <div className="verification-card-image" style={{ backgroundImage: `url(${item.image})` }}>
      ...
      <div className="verification-card-body">
        ...
        <div className="verification-card-actions">
          <button type="button" className="verification-button reject-button">Reject</button>
          <button type="button" className="verification-button approve-button">Approve</button>
        </div>
      </div>
    </article>
  )
...
function VerificationPage() {
  return (
    <section className="verification-page">
      ...
      <section className="verification-toolbar" aria-label="Verification filters">
      ...
      <section className="verification-grid" aria-label="Verification submissions">
